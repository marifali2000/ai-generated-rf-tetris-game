---
name: sound-effects
description: "Create breaking, shattering, cracking sound effects using Web Audio API. Use for: adding audio, sound design, glass breaking sounds, impact sounds, procedural audio, oscillator-based sounds, noise generation, volume control, mute functionality."
---

# Sound Effects Skill — "Breaking Off" Theme

## When to Use
- Adding or modifying sound effects
- Debugging Web Audio API issues
- Creating new procedural sounds for game events
...
- For multi-line clears, layer 2-3 instances with slight time offsets
...
2. Implement `init()` method with AudioContext creation
3. Add `createNoiseBuffer()` helper
